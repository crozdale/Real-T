                    ...
                    <div className="row sm-footer-nav text-center">
                        <div className='col-sm-12 my-auto'>
                            <p className="social-media">
                                    <a href="https://www.facebook.com/cogzidel"><i className="fa fa-facebook"></i></a>
                                    <a href="https://twitter.com/cogzideltech"><i className="fa fa-twitter"></i></a>
                                    <a href="https://plus.google.com/+Cogzidel"><i className="fa fa-google-plus"></i></a>
                                    <a href="http://www.youtube.com/results?search_query=cogzidel"><i className="fa fa-instagram"></i></a>
                                </p>
                        </div>
