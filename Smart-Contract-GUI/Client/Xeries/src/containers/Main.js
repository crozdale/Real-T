                                ...
                                <div className="nav-container">
                                    <div className="navbar-header">                                       
                                        <div className="site_logo">
                                            <a className="logo" href="/xeries/"><img className="navbar-brand logo" src={logo} alt="Xeries logo"/></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div className="col-md-9 col-sm-7 text-center">
                            <div>
                                <div className="hotel-tagline text-center">
                                    <h2 className='mb-5'>{texts.section1_title}</h2>
                                    <h1 className='pt-5'>{texts.section1_description}</h1>
                                </div>
                            </div>
                        </div>
                    </div>
		...
		<div className="row sm-footer back_img_cont">
			<div className="container clear-padding">
				<div className="col-md-4 col-sm-4 col-xs-10 car1_details">
					...
					<div dangerouslySetInnerHTML={{__html: texts.section3_description}} className="car_app_details" style={{color: "#fff"}}>
                    ...
                    <div className="container clear-padding">
                        ...
                        <div className="col-md-offset-3 col-md-6 col-sm-offset-3 col-sm-6">
                            <div className="choose-us-item text-center bg-transparent">
                                <Link className='col-12' to={'/xeries/home'}>Get Started</Link>
                            </div>
                        </div>
                    </div>
                </div>
