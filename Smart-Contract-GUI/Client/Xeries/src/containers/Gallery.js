                ...
                <CardActionArea>
                  ...
                  <CardContent>
                    ...
                    {item.owner && (
                      <>
                        ...
                        >
                          ...
                          />{" "}
                          <strong>Owner:</strong>{" "}
                          <NavLink to={`/${item.owner.username}`}>
                    ...
                    >
                      ...
                      />{" "}
                      <strong>Original Price:</strong> {item.priceOfOriginal}{" "}
                      USD
                    </Typography>
                    <Typography
                      variant="body2"
                    ...
                    >
                      ...
                      />{" "}
                      <strong>Canvas Copy Price:</strong> {item.priceOfCanvas}{" "}
                      USD
                    </Typography>
                    <Typography
                      variant="body2"
                    ...
                    >
                      ...
                      />{" "}
                      <strong>Paper Copy Price:</strong> {item.priceOfCopy} USD
                    </Typography>
                  </CardContent>
                </CardActionArea>
                {role && (
