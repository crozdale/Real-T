...
const ListingDetails = ({
  ...
  return (
    <>
            ...
            <div className="mv-3 row justify-content-centerw-75">
              ...
              <div className="row w-100">
                ...
                <ListItem className={classes.listItem}>
                  ...
                  <ListItemText
                    primary="Medium:"
                    secondary={listingData.item.medium}
                  />
                  <ListItemText
                    primary="Size:"
                    secondary={listingData.item.size}
                  />
                </ListItem>
                <ListItem className={classes.listItem}>
                  <ListItemText
                    primary="Original Price:"
                    secondary={`$ ${listingData.item.priceOfOriginal}`}
                  />
                  <ListItemText
                    primary="Canvas Copy Price:"
                    secondary={`$ ${listingData.item.priceOfCanvas}`}
                  />
                  <ListItemText
                    primary="Paper Copy Price:"
                    secondary={`$ ${listingData.item.priceOfCopy}`}
                  />
                </ListItem>
                <Divider />
                ...
                <div className="pb-3">
                  <p>
                    To see more listings from this art owner{" "}
                    <NavLink to={`/${listingData.item.owner.username}`}>
                      click here
                    </NavLink>
                  </p>
                </div>
      ...
      {!listingData.item.available && (
        <h3 className="p-5 m-5">Listing isn't available</h3>
      )}
    </>
  );
};
