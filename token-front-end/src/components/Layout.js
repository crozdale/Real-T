...
const appName = 'realT token manager';
    ...
    return (
      <div className={this.props.isMobile ? 'mobile' : ''}>
        {call2Action.message && this.state.visible && (
          <div
            className={call2Action.wrapperStyle ? '' : 'alertWrapper'}
            style={call2Action.wrapperStyle || {}}
          >
            <div
              style={
                this.props.isMobile
                  ? { padding: '0', paddingTop: '1em', paddingBottom: '1em' }
              ...
              <Grid>
                <Grid.Row columns={call2Action.columns || 2}>
                  <Grid.Column width={14}>
                    <Container>{call2Action.message}</Container>
                  </Grid.Column>
                  <Grid.Column
                    width={2}
                  ...
                  >
                    {this.props.isMobile ? (
                      ...
                      <a onClick={this.handleDismiss} className="dismiss">
                        DISMISS
                      </a>
                    )}
                  </Grid.Column>
        ...
        <div
          className={`header-section ${
            this.state.tokenLoaded ? 'tokenLoaded' : ''
          }`}
        >
          {this.props.isMobile ? (
            <div
              style={{ paddingTop: '2em', paddingBottom: '0', width: '100%' }}
            >
                    ...
                    <div style={{ verticalAlign: 'middle' }}>
                      {web3Service.isWeb3Viewable && (
                        <small className="meta-address-holder address">
                          {this.state.address &&
                          this.state.address !== NULL_ADDRESS ? (
                            <Address
                              url={
                                this.state.address
                                  ? `${web3Service.explorer}address/${this.state.address}`
                                  : ''
                              }
            ...
            <Container
              style={{ paddingTop: '2em', paddingBottom: '3em', width: '100%' }}
            >
              <Header
                as="h1"
                dividing
            ...
            <Route
              ...
              render={props => (
                <Content
                  ...
                  {...{
                    displayAddress: this.showUserAddress,
                    tokenLoadedFunc: this.setTokenLoaded,
                  }}
                  {...props}
                />
              )}
        ...
        <Container
          style={Object.assign(
            { marginTop: '3em' },
            this.props.isMobile ? mobilePadding : {}
          )}
        >
